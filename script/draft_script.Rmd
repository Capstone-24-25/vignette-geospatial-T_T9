...
>>>>>>> Stashed changes
=======
A table showing the average distance traveled by each of the following modes: Drive Alone, Passenger, and Walking on each day of the week for people with disability.
>>>>>>> Stashed changes
```{r}
